            ...
            <section className="section-info">
				<div className="container">
					...
					<div className="info-license">
						...
						<p>Лицензия № Л043-00131-22/00285346 от 04 октября 2019 года</p>
						<p>Акционерное общество «Научно-производственная компания «Здоровье Алтая»</p>
						<p>382653, АЛТАЙСКИЙ КРАЙ, ГОРОД БАРНАУЛ, ПР-КТ ЛЕНИНА, 71</p>
					</div>
				</div>
            </section>
        </div>
